...
public class PersonalInfoTests {
	...
	public void submitFullApplication() throws InterruptedException {
		...
		//mail confirmation number verification
		driver.get("https://outlook.live.com/owa/?path=/mail/inbox");
		driver.findElement(By.xpath("//a[@class='linkButtonFixedHeader office-signIn']")).click();
		driver.findElement(By.id("i0116")).sendKeys("msulgur92@outlook.com");
		driver.findElement(By.id("idSIButton9")).click();
		Thread.sleep(3000);
		driver.findElement(By.id("i0118")).sendKeys(                                                                                                         "fenerbahce@1992");
		Thread.sleep(3000);
		driver.findElement(By.id("idSIButton9")).click();
		driver.findElement(By.id("_ariaId_28")).click();
		driver.findElement(By.xpath("//*[@id=\"_ariaId_29\"]/div[2]/div[4]/div[3]/div/span")).click();
		String id = driver.findElement(By.xpath("(//td[@valign='top'])[3]")).getText();
		assertEquals(Appid.contains(id), true);
